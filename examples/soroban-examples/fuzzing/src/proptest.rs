...
use soroban_sdk::testutils::{arbitrary::arbitrary, Address as _, Ledger, MockAuthInvoke};
    ...
    fn test(
        ...
        soroban_sdk_tools::setup_mock_auth(
            ...
            MockAuthInvoke {
                ...
                fn_name: "mint",
                args: (depositor_address.clone(), i128::max_value()).into_val(&env),
                sub_invokes: &[],
            },
        );
        ...
        {
            let claimants = vec![&env, claimant_address.clone()];
        ...
        soroban_sdk_tools::setup_mock_auth(
            ...
            MockAuthInvoke {
                contract: &timelock_contract_id,
                fn_name: "claim",
                args: (claimant_address.clone(), input.claim_amount).into_val(&env),
                sub_invokes: &[],
            },
        );
