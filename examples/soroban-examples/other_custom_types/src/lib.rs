#![no_std]
use soroban_sdk::{
    contract, contractevent, contractimpl, contracttype, vec, Address, Bytes, BytesN, Env, Map,
    String, Symbol, Val, Vec, I256, U256, symbol_short,
};
...
impl CustomTypesContract {
    ...
    pub fn get_count(env: Env) -> u32 {
        Storage::new(&env).counter.get().unwrap_or(0)
    }
